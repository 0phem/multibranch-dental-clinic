...
| M8 | Patient Check-In Management | Staff → Check-In | Identity verification, scheduled/walk-in path, arrival, dentist/branch, queue handoff |
...
| M11 | Billing & Payment Management | Patient → Bills; Staff → Billing | Completed-treatment billing context, charge review, bill, payment, receipt, close transaction |
| M12 | HMO Verification & Documentation Management | Staff → HMO | Create case, eligibility, missing requirements, document completion, verification |
...
| M18 | Real-Time Patient Notification Management | Messages & Updates | Operational notifications, delivery status, failed-delivery retry |
...
| M23 | Integrated Workflow & Automation Control | Owner/Admin → Automation Control | Event/rule/action view, enable/disable, result/failure feed, central activity log concept |
