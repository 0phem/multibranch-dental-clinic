...
- Manual, Suggested-times (formerly "Find Best" before Phase 4B.1) and Follow-Up scheduling share one validator. Rescheduling cannot change Patient, cannot move an admitted/clinical encounter, and uses current configuration/overlap checks. No booking payment.
